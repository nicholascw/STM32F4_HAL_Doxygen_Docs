\hypertarget{stm32f4xx__hal__sdram_8c}{}\doxysection{src/stm32f4xx\+\_\+hal\+\_\+sdram.c 文件参考}
\label{stm32f4xx__hal__sdram_8c}\index{src/stm32f4xx\_hal\_sdram.c@{src/stm32f4xx\_hal\_sdram.c}}


S\+D\+R\+AM H\+AL module driver. This file provides a generic firmware to drive S\+D\+R\+AM memories mounted as external device.  


{\ttfamily \#include \char`\"{}stm32f4xx\+\_\+hal.\+h\char`\"{}}\newline
stm32f4xx\+\_\+hal\+\_\+sdram.\+c 的引用(Include)关系图\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=231pt]{stm32f4xx__hal__sdram_8c__incl}
\end{center}
\end{figure}
