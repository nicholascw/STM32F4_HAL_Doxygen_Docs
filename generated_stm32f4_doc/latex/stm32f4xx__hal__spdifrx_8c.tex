\hypertarget{stm32f4xx__hal__spdifrx_8c}{}\doxysection{src/stm32f4xx\+\_\+hal\+\_\+spdifrx.c 文件参考}
\label{stm32f4xx__hal__spdifrx_8c}\index{src/stm32f4xx\_hal\_spdifrx.c@{src/stm32f4xx\_hal\_spdifrx.c}}


This file provides firmware functions to manage the following functionalities of the S\+P\+D\+I\+F\+RX audio interface\+:  


{\ttfamily \#include \char`\"{}stm32f4xx\+\_\+hal.\+h\char`\"{}}\newline
stm32f4xx\+\_\+hal\+\_\+spdifrx.\+c 的引用(Include)关系图\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=234pt]{stm32f4xx__hal__spdifrx_8c__incl}
\end{center}
\end{figure}
